...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UGenerateSoundBanksCommandlet_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGenerateSoundBanksCommandlet_Statics::ClassParams = {
		...
		0,
		0x001000A8u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UGenerateSoundBanksCommandlet_Statics::Class_MetaDataParams), Z_Construct_UClass_UGenerateSoundBanksCommandlet_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_shang_OneDrive_Documents_Unreal_Projects_WwiseUE5Project_WwiseUE5_Plugins_Wwise_Source_AudiokineticTools_Classes_AssetManagement_GenerateSoundBanksCommandlet_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_shang_OneDrive_Documents_Unreal_Projects_WwiseUE5Project_WwiseUE5_Plugins_Wwise_Source_AudiokineticTools_Classes_AssetManagement_GenerateSoundBanksCommandlet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGenerateSoundBanksCommandlet, UGenerateSoundBanksCommandlet::StaticClass, TEXT("UGenerateSoundBanksCommandlet"), &Z_Registration_Info_UClass_UGenerateSoundBanksCommandlet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGenerateSoundBanksCommandlet), 4196659427U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_shang_OneDrive_Documents_Unreal_Projects_WwiseUE5Project_WwiseUE5_Plugins_Wwise_Source_AudiokineticTools_Classes_AssetManagement_GenerateSoundBanksCommandlet_h_3843399573(TEXT("/Script/AudiokineticTools"),
		Z_CompiledInDeferFile_FID_Users_shang_OneDrive_Documents_Unreal_Projects_WwiseUE5Project_WwiseUE5_Plugins_Wwise_Source_AudiokineticTools_Classes_AssetManagement_GenerateSoundBanksCommandlet_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_shang_OneDrive_Documents_Unreal_Projects_WwiseUE5Project_WwiseUE5_Plugins_Wwise_Source_AudiokineticTools_Classes_AssetManagement_GenerateSoundBanksCommandlet_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
